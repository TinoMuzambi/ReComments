...
const Privacy: React.FC = (): JSX.Element => {
	return (
		<>
			<Meta
				title="Privacy | ReComments"
				description="ReComments cares about your privacy and we endeavour to not misuse or abuse your data. Read our privacy policy here!"
