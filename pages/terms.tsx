...
const Terms: React.FC = (): JSX.Element => {
	return (
		<>
			<Meta
				title="Terms &amp; Conditions | ReComments"
				description="Check out the terms and conditions of ReComments. Nothing fancy though, the usual stuff."
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to ReComments.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to ReComments, accessible from{" "}
							<a
								href="https://recomments.tinomuzambi.com/"
