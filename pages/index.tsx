	...
	return (
		<main className="main index">
			...
			<section className="about">
				...
				<p className="text">
					<span className="accent">ReComments</span> is a site designed to bring
					back the ability to comment on YouTube videos where the uploader has
					decided to turn them off. You simply paste the video url on the search
					page then the video will be fetched. Once you navigate to the video,
					you'll be able to play the video on{" "}
					...
					will also notify you via email (promise no spam) when people reply to
					your comments.
				</p>
			</section>
			<section className="method">
				...
				<p className="text">
					<span className="accent">ReComments</span> uses the Google People API
					to facilitate signing into the site as well as storing only the
					necessary user data. Once you're signed in,{" "}
					<span className="accent">ReComments</span> uses the Google YouTube API
					to fetch video data.
				</p>
				<p className="text">
